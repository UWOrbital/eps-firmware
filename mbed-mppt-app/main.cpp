...
// Define periperhals
AnalogIn analog_pa0(PA_0, REF_V);
PwmOut gpio_pa1(PA_1);
...
int main()
{
    ...
    analog_pa0.set_reference_voltage(REF_V);
    printf("Initial ADC Vref %f\n", analog_pa0.get_reference_voltage());

    Mppt mppt_manager(&analog_pa0, &gpio_pa1);
    mppt_manager.run_mppt();
